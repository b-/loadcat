...
~~~
$ wget https://github.com/b-/loadcat/releases/download/v0.1-alpha.1/loadcat-0.1_alpha.1-1-x86_64.pkg.tar.xz
...
```
$ go get github.com/b-/loadcat/cmd/loadcatd
```
...
```
$ cd $GOPATH/src/github.com/b-/loadcat
# $GOPATH/bin/loadcatd
```
...
- [Reference](http://godoc.org/github.com/b-/loadcat)
